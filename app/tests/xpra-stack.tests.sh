...
main() {
  ...
  assert_contains "${joined}" "--encoding=rgb" "xpra command should use a lossless true-color encoding"
  assert_contains "${joined}" "--compress=0" "xpra command should avoid extra pixel compression"
